...
~\\
\section*{Frage 11}
Von der Konzentration der schwach dotierten Seite abhängig, da diese zu größerer Raumladungszone führt, da sich mehr Atome rekombinieren können.
~\\
~\\
\section*{Frage 12}
...
~\\
\section*{Frage 15}
Das Substrat dient als "Quelle" für Ladungen. Bekommt das Gate eine ausreichend große Spannung, werden Elektronen aus dem Bulk des Substrats vom Channel zwischen den Wannen unter dem Gate angezogen. Dies führt zu einer negativen Ladung in dieser Region, was letztendlich einen Stromfluss ermöglicht. \\
...
~\\
\section*{Frage 17}
Bei Finfets können kleinere Gatelängen verwendet werden, als bei planaren Transistoren. Dies führt dazu, dass auf gleichem Platz mehr Transistoren untergebracht werden können.\\
Beim normalen Planar Design stößt man hingegen bereits an die physikalischen Grenzen, was die Gate-Länge betrifft.\\
Auch bei Double Gate Transistoren ist der geringere Platzverbrauch die Hauptmotivation. Dies ist möglich durch das Design, durch reduzierte Short Channel Effekte . Es wird ein gutes Verhältnis der Stromstärke zwischen On/Off erzielt.\\
Ein weiter Vorteil ist auch, dass zum normalen Produktionsprozess lediglich Schritte hinzugefügt werden. Dies erleichtert die Umstellung auf die neue Produktserie einer Halbleiterfabrik.
~\\
~\\
\section*{Frage 18}
