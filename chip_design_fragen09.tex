...
~\\
\section*{Frage 2}
Zum einen verstärkt ein TG nicht, desweiteren muss bei TG darauf geachtet werden, dass der Ausgang niemals undefiniert ist wenn ein TG nicht leitend ist (offener Schalter).
~\\
~\\
\section*{Frage 3}
